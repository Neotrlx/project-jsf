 ...
 * 
 */
package com.neotrlx.projectjsf.controllers;
...
/**
 * @author neotrlx Clase que permite controlar el funcionamiento con la pantalla
 *         de login .xhtml.
 */
@ManagedBean
public class loginController {
	...
	/*
	 * Contraseña que ingresada en el login
	 */
	...
	public void ingresar() {
		...
		if (usuario.equals("neotrlx") && password.equals("12345")) {
			try {
